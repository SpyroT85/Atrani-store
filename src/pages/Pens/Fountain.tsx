          ...
          <MotionSection direction={index % 2 === 0 ? "left" : "right"} key={product.name}>
            <div className="w-full flex justify-center">
              ...
              >
                {index % 2 === 1 ? (
                  <>
                    <div className={`flex flex-col px-4 md:px-12 items-start justify-self-start`} style={{ textAlign: 'left' }}>
                  ...
                  <>
                    ...
                    <div className={`flex flex-col px-4 md:px-12 items-start justify-self-start`} style={{ textAlign: 'left' }}>
                      ...
                      <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                        <div style={{ height: '16px' }}></div>
                        <p className="text-black text-lg font-bold mb-2" style={{ marginBottom: '8px' }}>Price: {product.price}€</p>
                        <div style={{ height: '16px' }}></div>
                        <CartButton 
                          productId={product.id}
                          productName={product.name}
